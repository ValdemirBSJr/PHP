...
<script src="js/jquery.magnific-popup.min.js"></script>
    ...
    <body>
     ...
     <span  id="loading2"><img src="img/loading2.gif"/>Salvando...</span>
    ...
    <form id="formContact" class="col s12">
      ...
      <a  class="waves-effect waves-light btn red accent-1 hoverable"  id="UserFormButtonADMVERIFY"><i class="material-icons right">done</i>CADASTRAR</a>
    </form>
  </div>
