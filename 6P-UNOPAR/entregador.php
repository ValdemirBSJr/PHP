...
<?php
  ...
  <div class="row">
    <form class="col s12">
      ...
      <div class="row">
        <div class="input-field col s6">
          <p><label class="tooltipped" data-position="top" data-delay="60" data-tooltip="Escolha a empresa para qual o trabalhador entrega">EMPRESA FILIADA</label></p> <!-- Aqui eu coloquei por conta própria pra por seletor -->
		  <?php
		  //aqui gero dinamicamente as opções da empresa
