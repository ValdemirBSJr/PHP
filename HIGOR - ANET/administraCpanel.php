...
<script src="js/jquery.magnific-popup.min.js"></script>
	...
	<div id="resultMarket"></div>
				 ...
				 <a href="AtualizarcadastroAdm.php" target="_blank">Editar cliente</a><br>
   ...
   $contaLinhasPronto = $stmtPronto -> rowCount();
	...
	while ($obj = $stmt-> fetch (PDO::FETCH_NUM)) {
	  ...
	  echo '<td id="'.$obj[0].'">'.$obj[0].'</td>';
		...
		echo '<td id="'.$obj2[0].'"><p>Nome: '.$obj2[1].'</p>';
		 echo '<p>Endere&ccedilo: '.$obj2[5].', N&#176 '.$obj2[6].'.</p>';
		  echo '<p>Compl.: '.$obj2[8].'.</p>';
