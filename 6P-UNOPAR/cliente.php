...
<script type="text/javascript">
  //funçao que pega o clique no enter e pega o cliente no campo busca
 $(function(){
 $("#clienteConsulta").keyup(function (e) {
  if (e.which == 13) {
    $("#procuraCliente").trigger('click');
  }
 });
});
...
//Retorna o cliente logado
    ...
    <form class="col s12">
      <div class="row">
        <div class="input-field col s6">
          <input placeholder="Digite seu nome" id="clienteNome" type="text" class="validate">
          <label for="clienteNome">NOME</label>
        </div>
        <div class="input-field col s6">
          <input placeholder="Digite seu telefone" id="clienteTelefone" type="tel" class="validate">
          <label for="clienteTelefone">TELEFONE</label>
        </div>
      </div>
      <div class="row">
        <div class="input-field col s6">
          <input  placeholder="Digite seu endere&ccedilo" id="clienteEndereco" type="text" class="validate">
          <label for="clienteEndereco">ENDERE&CcedilO</label>
        </div>
      </div>
      </div>
      <div class="row">
        <div class="input-field col s6">
          <input placeholder="Digite ponto de referencia" id="clienteReferencia" type="text" class="validate">
          <label for="clienteReferencia">PONTO DE REFER&EcircNCIA</label>
        </div>
      </div>
      <div class="row">
        <div class="input-field col s2">
          <input id="clienteNascimento" type="text" class="validate" onkeypress="return dateMask(this, event)">
          <label for="clienteNascimento">DATA DE NASCIMENTO</label>
        </div>
      </div>
      
  <a  class="waves-effect waves-light btn"  onclick="mensagemCliente()"><i class="material-icons right">send</i>CADASTRAR</a>
  
  <a class="waves-effect waves-light btn" onclick="$('#retornoClienteModal').openModal();"><i class="material-icons left">phone</i>CONSULTAR CLIENTE</a>
  ...
  <div id="retornoClienteModal" class="modal">
    ...
    <div class="modal-footer">
      <a href="cliente.php" class="modal-action modal-close waves-effect waves-green btn-flat">SAIR</a>
         ...
         <!-- Modal Structure -->
  <div id="confirmaCliente" class="modal modal-fixed-footer">
    
    <div class="modal-content">
      <h2>CADASTRO DE CLIENTE</h2>
      <h4>Tem certeza que deseja efetuar o cadastro do cliente abaixo?</h4>
      <h6 id="mostra.cliente" ></h6>
      <h6 id="mostra.telefone" ></h6>
      
    </div>
    <div class="modal-footer">
      <a  class="modal-action modal-close waves-effect waves-green btn-flat ">DESCARTAR</a>
      <a  class="modal-action modal-close waves-effect waves-green btn-flat " id="cadastraCliente">SALVAR</a>
    </div>
  </div>
  ...
  <div id="erroCadastro" class="modal modal-fixed-footer">
    ...
    <div class="modal-content">
      <h2>ERRO NO CADASTRO DE CLIENTE</h2>
