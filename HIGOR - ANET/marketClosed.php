...
try {
	...
	if ($stmt -> rowCount() < 1)
	{
		 //$openMarket = "Loja Fechada! marketClosed";
  ...
  <nav>
    ...
    <ul class="slides">
      ...
      <div class="col s12 m12">
        <div class="card-panel red darken-4">
          <span class="white-text"><h4>Prezado cliente, nosso hor&aacuterio de atendimento &eacute de sexta a domingo, das 18:00 as 23:00. Caso queira se deliciar com o melhor sushi da cidade e n&atildeo &eacute cadastrado, <a href="cadastro.php">Clique aqui.</a></h4></span>
          </span>
        </div>
      </div>
    </div>
   ...
   echo '<div class="card">';
    ...
    <div class="card-content">
      <span class="card-title activator grey-text text-darken-4" id="title'.$obj[0].'">'.utf8_decode($obj[1]).'</span>
      <p><a href="#!" class="activator">Solicite seu pedido quando a loja estiver aberta!</a></p><!--A classe activator é que faz o efeito de revelar o card -->
    </div>
    <div class="card-reveal">
      <span class="card-title grey-text text-darken-4">'.$obj[1].'<i class="material-icons right">close</i></span>
       <h5>'.utf8_decode($obj[2]).'</h5>
      ...
      <h6 align="center"><button id="'.$obj[0].'" class="btn disabled" name="action">Adicionar ao carrinho</button></h6>
      </p>
      </div>
      </div>';
   ...
   if  (isset($_SESSION['NAMECLI'] ))
   {
    ...
    <ul>
      <li><a class="btn-floating red"><img src="img/mail59.png"/></a></li>
      <li><a class="btn-floating yellow darken-4"><img src="img/instagram12.png"/></a></li>
