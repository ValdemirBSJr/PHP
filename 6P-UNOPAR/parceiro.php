...
function pegaParceiro()
{
  ...
  var nome ="Nome do parceiro: " + document.getElementById('parceiroNome').value;
  var descricao = "Telefone do parceiro: " + document.getElementById('parceiroTelefone').value;
...
$(document).ready(function() {
	$("#cadastraParceiro").click(function(event) {
		...
		$.post('insertDataParceiro.php',{parceiroNome:nome, parceiroCnpj:cnpj, parceiroEndereco:endereco, parceiroTelefone:telefone, parceiroEmail:email},
		function call_back(data){
...
<?php
  ...
  <main class="mdl-layout__content">
    ...
    <div class="page-content">
      ...
      <h2 align="center">Cadastro de Parceiros</h2>
    ...
    <form class="col s12">
      ...
      <div class="row">
        <div class="input-field col s12">
          ...
          <label for="parceiroEndereco">ENDERECO</label>
        </div>
      </div>
	   <div class="row">
        <div class="input-field col s6">
      ...
      <div class="row">
        <div class="input-field col s6">
          <input  id="parceiroEmail" type="text" class="validate">
