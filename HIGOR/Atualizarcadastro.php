    ...
    <form id="formContact" class="col s12">
      <div class="row">
        <div class="input-field col s6">
          ...
          <input id="nome" type="text" name="campoNome" class="validate" <?php echo "value='".utf8_decode($_SESSION['NAMECLI'])."'"; ?>>
          <label for="nome">Nome</label>
        </div>
        <div class="input-field col s6">
          <i class="material-icons prefix">assignment_ind</i>
          <input id="sobrenome" type="text" class="validate" <?php echo "value='".utf8_decode($_SESSION['CLISOBRENOME'])."'"; ?>>
        ...
        <div class="input-field col s8">
          ...
          <input id="endereco" type="text" class="validate" <?php echo "value='".utf8_decode($_SESSION['ENDCLI'])."'"; ?>>
        ...
        <div class="input-field col s12">
          ...
          <input id="complemento" type="text" class="validate" <?php echo "value='".utf8_decode($_SESSION['COMPLENDCLI'])."'"; ?>>
